...
public class CorporationCardArticleFragment_ViewBinding implements Unbinder {
  private CorporationCardArticleFragment target;

  @UiThread
  public CorporationCardArticleFragment_ViewBinding(CorporationCardArticleFragment target,
      View source) {
    this.target = target;
  ...
  @CallSuper
  public void unbind() {
    CorporationCardArticleFragment target = this.target;
