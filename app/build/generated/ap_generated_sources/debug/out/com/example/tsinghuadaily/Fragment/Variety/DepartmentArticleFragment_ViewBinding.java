...
public class DepartmentArticleFragment_ViewBinding implements Unbinder {
  private DepartmentArticleFragment target;

  @UiThread
  public DepartmentArticleFragment_ViewBinding(DepartmentArticleFragment target, View source) {
    this.target = target;
  ...
  @CallSuper
  public void unbind() {
    DepartmentArticleFragment target = this.target;
