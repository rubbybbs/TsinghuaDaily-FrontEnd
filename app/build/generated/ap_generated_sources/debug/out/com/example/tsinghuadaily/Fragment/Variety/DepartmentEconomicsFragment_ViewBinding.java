...
public class DepartmentEconomicsFragment_ViewBinding implements Unbinder {
  private DepartmentEconomicsFragment target;

  @UiThread
  public DepartmentEconomicsFragment_ViewBinding(DepartmentEconomicsFragment target, View source) {
    this.target = target;
  ...
  @CallSuper
  public void unbind() {
    DepartmentEconomicsFragment target = this.target;
