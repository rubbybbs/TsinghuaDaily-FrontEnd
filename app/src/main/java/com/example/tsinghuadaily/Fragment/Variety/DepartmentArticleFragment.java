...
import com.example.tsinghuadaily.Fragment.TabScrollableFragment;
 ...
 */
@Widget(widgetClass = DepartmentArticleFragment.class, iconRes = R.mipmap.ic_launcher)
public class DepartmentArticleFragment extends BaseFragment {
    ...
    private class GetArticleListTask extends AsyncTask<Void, Void, Void> {
        ...
        protected Void doInBackground(Void... voids) {
            String baseurl = "http://175.24.61.249:8080/article/section-articles?section_id=1&page_num="+ mCurrentPageNum +"&page_size=10";
