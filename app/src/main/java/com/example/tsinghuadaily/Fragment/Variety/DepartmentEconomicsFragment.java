 ...
 */
@Widget(widgetClass = DepartmentEconomicsFragment.class, iconRes = R.mipmap.ic_launcher)
public class DepartmentEconomicsFragment extends BaseFragment {
...
//                        item.setDetailText(article.get("article_id").toString() + " " +article.get("publish_time"));
    ...
    private class GetArticleListTask extends AsyncTask<Void, Void, Void> {
        ...
        protected Void doInBackground(Void... voids) {
            String baseurl = "http://175.24.61.249:8080/article/section-articles?section_id=2&page_num="+ mCurrentPageNum +"&page_size=10";
